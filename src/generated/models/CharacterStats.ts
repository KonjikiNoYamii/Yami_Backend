...
// @ts-nocheck 
/*
 * This file exports the `CharacterStats` model and its related types.
 *
...
export type GetCharacterStatsAggregateType<T extends CharacterStatsAggregateArgs> = {
    ...
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateCharacterStats[P]>
    : Prisma.GetScalarType<T[P], AggregateCharacterStats[P]>
}
...
type GetCharacterStatsGroupByPayload<T extends CharacterStatsGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<CharacterStatsGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof CharacterStatsGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], CharacterStatsGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], CharacterStatsGroupByOutputType[P]>
      }
    >
  >
...
export type CharacterStatsCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
...
export interface CharacterStatsDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  ...
  **/
  count<T extends CharacterStatsCountArgs>(
    args?: Prisma.Subset<T, CharacterStatsCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], CharacterStatsCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, CharacterStatsGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetCharacterStatsGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
